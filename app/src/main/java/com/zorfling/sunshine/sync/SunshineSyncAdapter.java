package com.zorfling.sunshine.sync;
...
import com.zorfling.sunshine.DetailActivity;
import com.zorfling.sunshine.R;
import com.zorfling.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static Account getSyncAccount(Context context) {
        Log.d(TAG, "getSyncAccount called");
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
        Log.d(TAG, "onAccountCreated called");
        /*
    ...
    private void notifyWeather() {
        ...
        boolean showNotifications = prefs.getBoolean(context.getString(R.string.pref_notification_key), true);
        ...
        if (showNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    // Intent to open - details for today
                    Intent todayIntent = new Intent(context, DetailActivity.class)
                            .setData(weatherUri);
                    ...
                    stackBuilder.addNextIntent(todayIntent);
                    PendingIntent todayPendingIntent =
                            stackBuilder.getPendingIntent(
                                    0,
                                    PendingIntent.FLAG_UPDATE_CURRENT
                            );
                    builder.setContentIntent(todayPendingIntent);
            ...
            // don't show notifications, so reset last notified too
            if (lastSync != 0) {
                SharedPreferences.Editor editor = prefs.edit();
